...
let AppComponent = class AppComponent {
    constructor(paging, birdService, domesticService, wildService) {
        this.paging = paging;
...
let DomesticCardComponent = class DomesticCardComponent {
    constructor(domesticService) {
        this.domesticService = domesticService;
    }
    ngOnInit() {
    }
};
DomesticCardComponent.ctorParameters = () => [
...
let BirdPanelComponent = class BirdPanelComponent {
    constructor(birdService) {
        this.birdService = birdService;
    }
    ngOnInit() {
...
BirdPanelComponent.ctorParameters = () => [
    { type: _services_bird_service__WEBPACK_IMPORTED_MODULE_2__["BirdService"] }
];
...
let DomesticPanelComponent = class DomesticPanelComponent {
    constructor(domesticService) {
        this.domesticService = domesticService;
    }
    ngOnInit() {
...
DomesticPanelComponent.ctorParameters = () => [
    { type: _services_domestic_service__WEBPACK_IMPORTED_MODULE_2__["DomesticService"] }
];
...
let WildPanelComponent = class WildPanelComponent {
    constructor(wildService) {
        this.wildService = wildService;
    }
    ngOnInit() {
...
WildPanelComponent.ctorParameters = () => [
    { type: _services_wild_service__WEBPACK_IMPORTED_MODULE_2__["WildService"] }
];
...
let DomesticService = class DomesticService {
    constructor() {
        this.domestics = [
